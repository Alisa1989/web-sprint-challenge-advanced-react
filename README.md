...
1. Explain how to build stateful class components.
  We need to extend the React.Component parent class, invoke its constructor using the 'super()' keyword, and then initialize our state.

2. Describe the different phases of the component lifecycle.
  The component lifecycle mounts (birth), updates(growth) and unmounts(death)

3. Demonstrate an understanding of class component lifecycle methods.
  ComponentDidMount - will call the render method
  ComponentDidUpdate - will change the component's state
  ComponentWillUnmount - removes the component from the screen

4. Define stateful logic.
  Stateful logic is built into a component and it is logic concerning the state, like a setState, a formatting function, or a click event.

5. Describe how to test a React component with React Testing Library.
  To test a react component with RTL it is necessary to grab the component to be tested (Arrange)
  Set up a test (Act)
  Make sure that the test works as expeted (Assert)
